...
export default function ProjectDetail() {
  ...
  return (
    <>
      ...
      <div className="container min-h-screen mx-auto p-2 lg:p-6">
        <div className="flex flex-col lg:flex-row mt-4">
          <div className="flex-1 p-4">
            ...
            <span className="border-b border-gray-300 mt-4 block"></span>
...
const ErrorMessage = () => (
  <div className="text-center text-red-500 mt-10">Failed to load project.</div>
);
