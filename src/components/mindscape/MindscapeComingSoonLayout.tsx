...
import { Bell, Clock, FileText, Pencil, BookOpen } from "lucide-react";
...
interface BlogComingSoonLayoutProps {
  title: string;
  description: string;
    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 text-center">
        ...
        >
          ...
          <ButtonNav href="/notes" label="Back to Notes" />
